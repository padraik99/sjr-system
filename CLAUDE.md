...
| `shaylan_boot_phase_v1_20260616.html` | **v1.0 NEW** | 6-wk strict-NWB navicular block (R navicular SF, nondisplaced, MRI 6/15 · Falcocchia/KP) — core + controlled upper-body lifting cleared; 4-day template (push/NWB arm-bike conditioning/pull/hypertrophy+mobility) + 6-wk volume progression; leg tier (L-leg loaded + R-leg open-chain knee/iso, zero foot/ankle load) **verbally cleared, reconfirm in writing**; pool ruled out; bone-fueling note (RED-S neg, dietitian ref); reexam-prep checklist (imaging-before-WB, return-to-run protocol) · medical-deference framing |
