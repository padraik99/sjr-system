...
| Hash | Message |
|------|---------|
| _pending_ | **Patrick v7.0** (uncommitted — push via GitHub Desktop): hybrid console + grouped 0–10 log redesign. Suggested commit: `Patrick v7.0: hybrid console + grouped 0–10 log (Ankle→Nerve), doctor summary, treatment tracker, demo links on rehab rows — thresholds rescaled` · Note (Jul 4): everything below through v6.0.4 + contrast fix has LANDED on origin/main (`947eb36`, `75dac44` etc.) — Patrick pushed between sessions; rows kept for history |
